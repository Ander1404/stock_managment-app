...
if (
    ...
    $mail = $_POST["mail"];
    try {
        $sql = " CALL InsertOrUpdateFournisseur (:id_fournisseur,:noms,:telephone,:adresse,:mail); ";
       // $sql = " update tfournisseur set noms=:noms,telephone=:telephone,adresse=:adresse,mail=:mail where id_fournisseur=:id_fournisseur; ";
