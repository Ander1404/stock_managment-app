...
if (
    ...
    $mail = $_POST["mail"];
    try {
        $sql = " CALL InsertOrUpdateClient (:id_client,:noms,:telephone,:adresse,:mail); ";
       // $sql = " update tclient set noms=:noms,telephone=:telephone,adresse=:adresse,mail=:mail where id_client=:id_client; ";
